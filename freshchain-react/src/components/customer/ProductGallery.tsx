  ...
  return (
    <div className="px-4 md:px-6 space-y-6">
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div>
          <h2 className="text-2xl md:text-3xl font-bold tracking-tight">Product Gallery</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
        {batches.map((batch) => (
          <Card
            key={batch.batchId}
            className="group hover:shadow-lg transition-all duration-300 cursor-pointer border-2 hover:border-primary rounded-lg"
          ...
          >
            ...
            <CardContent className="space-y-3">
              ...
              <div className="flex items-center justify-between text-sm">
                ...
                <span className="font-mono text-xs truncate max-w-[120px]" title={batch.producer}>
